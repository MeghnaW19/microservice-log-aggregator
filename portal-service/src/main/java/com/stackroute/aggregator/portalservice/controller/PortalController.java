...
public class PortalController {
    ...
    public ResponseEntity<User> getUserDetails(@PathVariable(name = "customerId", required = true) long customerId){
        log.info("GET /user/"+customerId);
        User user = new User();
        user.setCustomer(restTemplate.getForObject("http://customer-service/customer/"+customerId, Customer.class));
        user.setAddress(restTemplate.getForObject("http://address-service/address/"+customerId, Address.class));
